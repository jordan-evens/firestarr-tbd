...
run_fires <- function(in_file, actualsOnly)
{
    ...
    file.copy('Release/tbd.exe', run_dir)
...
run_constant <- function (out_dir, numDays=1, slope=0, aspect=0, wind_speed=20, wind_direction=180) {
    print(paste0("tbd.exe test ", out_dir,
                    " ", numDays,
                    " ", slope,
                    " ", aspect,
                    " ", wind_speed,
    ...
    system(paste0("tbd.exe test ", out_dir,
                    " ", numDays,
                    " ", slope,
                    " ", aspect,
                    " ", wind_speed,
