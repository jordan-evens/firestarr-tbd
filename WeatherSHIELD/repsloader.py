...
class HPFXLoader(WeatherLoader):
    ...
    indices = {
        'TMP': WeatherIndex('TMP', [':TMP', ':2 m above ground:'], 'AGL-2m'),
        'UGRD': WeatherIndex('UGRD', [':UGRD', ':10 m above ground:'], 'AGL-10m'),
        'VGRD': WeatherIndex('VGRD', [':VGRD', ':10 m above ground:'], 'AGL-10m'),
        'RH': WeatherIndex('RH', [':RH', ':2 m above ground:'], 'AGL-2m'),
        'APCP': WeatherIndex('APCP', [':APCP', ':surface:'], 'SFC')
    }
